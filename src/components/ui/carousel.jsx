  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ...
        style={{
          transform:
            current !== index ? "scale(0.9) rotateX(8deg)" : "scale(1) rotateX(0deg)",
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center">
            <button className="mt-6 px-4 py-2 w-fit mx-auto sm:text-sm text-black bg-white h-12 border border-transparent text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] hover:bg-[#6D64F7] hover:text-white">
              {button}
            </button>
          </div>
        </article>
...
const CarouselControl = ({ type, title, handleClick }) => {
  return (
    <button
      className={`w-12 h-12 flex items-center mx-2 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#6D64F7] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
